...
function runTests(groupName, { h, Component }) {
  ...
  describe(`PreactElementAdapter (${groupName}`, function () {
    ...
    describe('getAttributes', function () {
      ...
      it('excludes a ref with default options', function () {
        expect(adapter.getAttributes(<div ref={() => {
          }} className="foo">bar</div>),
          'to equal',
          { class: 'foo' }
        );
      });
      ...
      it('gets the attributes of a child node', function () {

        const rootNode = (
          <div>
            <span className="foo">a</span>
          </div>
        );
    ...
    describe('getChildren', function () {
      ...
      it('returns multiple child elements', function () {
        expect(adapter.getChildren(<div><span />
          <aside />
        </div>), 'to equal', [<span />, <aside />])
      });
...
runTests('preact', { h: Preact.h, Component: Preact.Component });
runTests('preact-compat', { h: PreactCompat.createElement, Component: PreactCompat.Component });
